      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
          ...
          <ul className="ml-12 inline-flex space-x-8">
            {menuItems.map((item) => (
              <li key={item.name}>
                ...
                } inline-flex items-center text-lg font-semibold text-gray-800 hover:text-red-700`}
                >
                  {item.name}
                </NavLink>
              </li>
        ...
        <div className="hidden space-x-2 lg:block">
          ...
          <NavLink
            to="login"
            type="button"
            className="rounded-md border bg-black border-black px-3 py-2 text-lg font-semibold text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
          >
            Log In
          </NavLink>
        </div>
            ...
            <div className="divide-y-2 divide-gray-50 rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5">
              <div className="px-5 pb-6 pt-5">
                ...
                <div className="mt-2 space-y-2">
                  ...
                  <button
                    type="button"
                    className="w-full rounded-md bg-black px-3 py-2 text-lg font-semibold text-white shadow-sm hover:bg-black/10 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
                  >
                    Log In
                  </button>
                </div>
